...
export const SCHEMA = {
  ...
  "synth.carrierType": {
    kind: "enum",
    default: "sine" as OscillatorType,
    options: ["sine", "triangle", "sawtooth"] as const,
    label: "Carrier wave",
    group: "synth",
    hint: "Waveform for all pad carrier oscillators — sine = pure, triangle = soft harmonics, sawtooth = bright/buzzy",
  },
  "synth.glideSpread": {
    kind: "number",
    default: 1.0,
